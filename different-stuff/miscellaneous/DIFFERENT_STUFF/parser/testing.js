...
// процесс мастер не вічодит потому что на входе больше елементов
//а на виходе меньше потому что ми убрали повторяющиеся значения!
