...
const toEither = R.curry(
  (left, v) => (R.isNil(v) && Either.Left(left)) || Either.of(v)
);

const base64ToJson = R.compose(safe(parse), atob);
const safeNth = R.curry(
  R.compose(toEither('value with index nth is undefined or null'), nth)
);
