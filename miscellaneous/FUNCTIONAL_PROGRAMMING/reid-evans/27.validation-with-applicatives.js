...
/** @: stateFromCity :: String -> Either Error String */
const stateFromCity = (city) => {
  switch (city) {
    case 'city-1':
      return Either.Right('state-1');
    case 'city-2':
      return Either.Right('state-2');
    default:
      return Either.Left({ step: 'stateFromCity', value: city });
  }
};

/** @: locationFromCity :: String -> Either Error Location */
const locationFromCity = (city) =>
  liftedGetLocation(Either.Right(city), stateFromCity(city));
