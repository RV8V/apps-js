...
const validImperative = users =>_.filter(users, user => user.name === CRETERIA)
const completedImperative = tasks => _.filter(tasks, { completed: COMPLETED })
...
const checkDeclavative = R.compose(wasNaturalist, wasBornInOurCountry, canDrive)

const isCitizenImperative = person => wasBornInOurCountry(person) || wasNaturalist(person)
